...
fun ItemsScreen(
    ...
    val database = items.filter {
        it.itemCategory.lowercase() == selectedCategory
    }
    ...
    LazyVerticalGrid(
        ...
        item(
            ...
            Column {
                Image(painter = painterResource(id =R.drawable.banner2 ), contentDescription = "Offer",
                    modifier = Modifier
                        .fillMaxSize()
                        .fillMaxWidth())
                Card(
...
fun LoadingScreen() {
    Box(contentAlignment = Alignment.Center, modifier = Modifier.fillMaxSize()) {
        Image(painter = painterResource(id = R.drawable.load), contentDescription = "loading")
    }
}
    @Composable
    fun ErrorScreen(flashViewModel: FlashViewModel) {
        Column(
            ...
            Text(text = "Oops! Internet unavailable, Please check your connection",
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(20.dp),
            textAlign = TextAlign.Center)
