...
fun CartScreen(
    ...
    if (cartItems.isNotEmpty()){
        LazyColumn(contentPadding = PaddingValues(horizontal = 10.dp),
            ...
            item {
                Image(painter = painterResource(id = R.drawable.banner3), contentDescription ="Offer" )
            }
            item {
...
Image(painter = painterResource(id = R.drawable.cartempty), contentDescription = "Cart Empty",
