    ...
    auth.signInWithCredential(credential)
        .addOnCompleteListener(context as Activity) { task ->
            if (task.isSuccessful) {
                ...
                Toast.makeText(context, "Verification Succesful", Toast.LENGTH_SHORT).show()
                ...
                if (task.exception is FirebaseAuthInvalidCredentialsException) {
                    ...
                    Toast.makeText(context, "The OTP YOU have entered here is invalid. Please try again.", Toast.LENGTH_SHORT).show()
                }
                // Update UI
            }
        }
